...
public class PerftTest {
    ...
    public void perftTest() {
        Perft perft = new Perft(new BoardFactory().newGameBoard());
        perft.perft(4);
...
//        MutableBoard mb = MutableBoard.from(board);
//        Perft perft = new Perft(mb);
    ...
    public void perftPosition3Test() {
        Board board = new BoardSerializer().readFromFEN("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1");
        Perft perft = new Perft(board);
        perft.perft(4);
    ...
    public void perftPosition6Test() {
        Board board = new BoardSerializer().readFromFEN("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10");
        Perft perft = new Perft(board);
        perft.perft(4);
